...
class PlayerTest(unittest.TestCase):
    ...
    muncy = Player(
        ...
        "Muncy",
        123531,
        BaseballSlot.first() | BaseballSlot.third(),
        None,
    )
    merrifield = Player(
        "Whit Merrifield",
        ...
        "Merrifield",
        56263,
        BaseballSlot.second() | BaseballSlot.outfield(),
        None,
    )
    carpenter = Player(
        "Matt Carpenter",
    ...
    springer = Player(
        "George Springer", None, None, 18946, BaseballSlot.outfield(), None
    )
    ...
    peraza = Player(
        ...
        None,
        74395,
        BaseballSlot.second() | BaseballSlot.short(),
        None,
    )
    olson = Player(
        "Matt Olson",
        ...
        "Olson",
        14632718,
        {BaseballSlot.INJURED, BaseballSlot.BENCH},
        None,
    )
    jimenez = Player(
        "Eloy Jimenez",
    ...
    hill = Player(
        "Rich Hill", None, None, 57346, BaseballSlot.pitcher(), BaseballPosition.STARTER
    )
    arrieta = Player(
        "Jake Arrieta",
        None,
