...
class Test(unittest.TestCase):
    ...
    def test_conversion(self):
        ...
        self.assertEqual(
            nolan.possible_positions, BaseballSlot.third() | {BaseballSlot.INJURED}
        )
        ...
        self.assertEqual(
            travis.possible_positions,
            BaseballSlot.second() | BaseballSlot.third() | {BaseballSlot.INJURED},
        )
        self.assertEqual(travis.default_position, BaseballPosition.FIRST)

    lineup_slot_response = {
        "0": 1,
        "1": 1,
        "2": 1,
        "3": 1,
    ...
    def test_convert_lineup_slot_counts(self):
        ...
        self.assertEqual(
            Test.bb_api.lineup_slot_counts_to_lineup_settings(
                self.lineup_slot_response
            ).slot_counts,
